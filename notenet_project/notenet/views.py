...
SUBJECTS = {
    (8, 'system'): [
        {'name': 'Intro into Programming', 'slug': 'intro_program'},
        {'name': 'IT', 'slug': 'it'},
        {'name': 'Intro to Specialty', 'slug': 'intro_special'},
        {'name': 'English', 'slug': 'english'},
        {'name': 'Physics', 'slug': 'physycs'},
    ...
    (11, 'networks'): [
        ...
        {'name': 'BOMT', 'slug': 'bomt'},
        {'name': 'Networks', 'slug': 'networkssubj'},
        {'name': 'Maths programming', 'slug': 'math_progr'},
        {'name': 'VMKS', 'slug': 'vmks'},
        {'name': 'KTT', 'slug': 'ktt'},
        {'name': 'GO', 'slug': 'go'},
        {'name': 'Maths', 'slug': 'maths'},
    ...
    (12, 'networks'): [
        ...
        {'name': 'System Administration', 'slug': 'system_adm'},
        {'name': 'IoT', 'slug': 'iot'},
        {'name': 'VMKS', 'slug': 'vmks'},
        {'name': 'Literature', 'slug': 'literature'},
        {'name': 'English', 'slug': 'english'},
